...
// ============================================================================
// Cooperative Kernel Host-Side API
// 
// Forward declarations for the cooperative kernel launch functions.
// Include this from C++ files (deep_ep.cpp) instead of the .cuh headers
// which contain CUDA device code.
// ============================================================================
...
// Dispatch send: count + pack + signal
...
// Dispatch recv: poll flags + unpack
...
// Combine send: pack expert output + signal
...
// Combine recv: poll flag + weighted reduction
