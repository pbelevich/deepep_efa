...
// NOTE: In EFA mode, we never define __CUDACC_RDC__ since we don't use
// NVSHMEM device symbols. This avoids the need for -rdc=true and device link.
...
// NVSHMEM is always disabled in EFA mode - no NVSHMEM includes needed
// The internode functionality is provided by the EFA transport layer
